...
public class BookingTicket {
	    ...
	    public BookingTicket(String passengerUsername, String busName, String source, String destination, int numSeats) {
	    ...
	    public void cancelBooking(BusBookingSystem bus, Passenger loggedInPassenger, int bookingId) {
