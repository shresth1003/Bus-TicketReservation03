...
public class BusInformation {
	    ...
	    static List<BusBookingSystem> busList = new ArrayList<>();

	    // List to store all the bookings
	     static List<BookingTicket> bookingList = new ArrayList<>();

	    // Method for user login
	    public boolean login(String username, String password) {
	        // Check if the username and password match with the admin credentials
	        if (username.equals("shreshth") && password.equals("shreshth")) {
	            return true;
	        }
	        return false;
	    }
	    ...
	    public void addBus(String busName, int busNo, String source, String destination, String busType,
	    	...
	    	BusBookingSystem bus = new BusBookingSystem(busName, busNo, source, destination, busType, departureTime, arrivalTime, totalSeats);
	    ...
	    public void viewAllBookings() {
	        ...
	        for (BookingTicket booking : bookingList) {
