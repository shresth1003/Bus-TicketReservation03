...
public class MainPage {
	    ...
	    public static void main(String[] args) {
	        ...
	        if (option == 1) {
	            // Admin actions
	          BusInformation admin = new BusInformation();
	          ...
	          if (businformation.login(username, password)) {
	              ...
	              do {
	                  ...
	                  switch (choice) {
	                      case 1:
	                          ...
	                          businformation.addBus(busName, busNo, source, destination, busType, departureTime, arrivalTime, totalSeats);
	                          break;
	                      case 2:
	                          System.out.print("Enter bus name: ");
	                          ...
	                          businformation.updateBus(busName, busNo, newBusName, newBusType, newTotalSeats);
	                          break;
	                      case 3:
	                          System.out.print("Enter bus name: ");
	                          busName = scanner.next();
	                          System.out.print("Enter bus number: ");
	                          busNo = scanner.nextInt();
	                          businformation.deleteBus(busName, busNo);
	                          break;
	                      case 4:
	                    	  businformation.viewAllBookings();
	                          break;
	                      case 5:
	                          ...
	                          businformation.viewBookingsByDate(startDate, endDate);
	                          break;
	                      case 6:
	                          System.out.print("Enter bus name: ");
	                          busName = scanner.next();
	                          businformation.viewBookingsByBusName(busName);
	                          break;
	                      case 7:
	                          System.out.print("Enter user name: ");
	                          String userName = scanner.next();
	                          businformation.viewBookingsByUserName(userName);
	                          break;
	                      case 8:
	          ...
	          Scanner scanner = new Scanner(System.in);
	        	        ...
	        	        while (true) {
	        	            ...
	        	            switch (choice) {
	        	                case 1:
	        	                    // View all buses
	        	                	if(BusInformation.busList.size()==0) {
	        	                		System.out.println("There is no buses");
	        	                	}else {        	                		
	        	                		for (BusBookingSystem bus : BusInformation.busList) {
	        	                ...
	        	                case 6:
	        	                    ...
	        	                    for (BookingTicket booking : loggedInPassenger.getBookingHistory()) {
...
//	        	                            
	        	                ...
	        	                case 8:
	        	                	...
	        	                	BusBookingSystem bus = null;
	        	                	for (BusBookingSystem b : BusInformation.busList) {
	        	                	...
	        	                	BookingTicket booking = new BookingTicket(passengerUsername, busName, source, destination, numSeats);
