package com.shreshth;
	...
	public class Passenger {
	    ...
	    private ArrayList<BookingTicket> bookingHistory;
	    ...
	    public Passenger(String firstName, String lastName, String address, String mobileNo, String username, String password) {
	        ...
	        this.bookingHistory = new ArrayList<BookingTicket>();
	    }
		...
		public ArrayList<BookingTicket> getBookingHistory() {
			return bookingHistory;
		}



		public void setBookingHistory(ArrayList<BookingTicket> bookingHistory) {
...
//		 Method to view list of all buses
	    public void viewAllBuses(ArrayList<BusBookingSystem> busList) {
	        for (BusBookingSystem bus : busList) {
	...
	//   Method to book ticket by selecting bus number
	    public void bookTicket(ArrayList<BusBookingSystem> busList) {
	        ...
	        for (BusBookingSystem bus : busList) {
	            if (bus.getBusNo() == busNo) {
	                if (bus.getTotalSeats() - bus.getBookedSeats() >= numSeats) {
	                    ...
	                    BookingTicket booking = new BookingTicket(bus.getBusName(),bus.getSource(),bus.getBusType(),bus.getDestination(),bus.getAvailableSeats());
	    ...
	    public void cancelTicket() {
	        ...
	        for (BookingTicket booking : bookingHistory) {
	 ...
	 // Method to add a booking to the booking history
	    ...
	    public void cancelBooking(BookingTicket booking) {
